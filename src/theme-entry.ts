// Server-safe entry: "@marcfs31/fors-observability-design-system/theme". No "use client" — these
...
// bundle ("@marcfs31/fors-observability-design-system") is a separate client entry.
